...
DETECTION_THRESHOLD="${DETECTION_THRESHOLD:-0.0}"
CONDITION_KEY="${CONDITION_KEY:-disease}"
CONDITION_REFERENCE="${CONDITION_REFERENCE:-normal}"
STUDY_KEY="${STUDY_KEY:-dataset_id}"
MIXED_MODEL_MIN_CELLS="${MIXED_MODEL_MIN_CELLS:-10}"
MIXED_MODEL_MIN_DONORS="${MIXED_MODEL_MIN_DONORS:-3}"
MIXED_MODEL_MIN_STUDIES="${MIXED_MODEL_MIN_STUDIES:-3}"
MIXED_MODEL_MIN_REPEATED_CONTEXTS="${MIXED_MODEL_MIN_REPEATED_CONTEXTS:-3}"
...
main() {
  ...
  python_args=(
    ...
    --study-key "${STUDY_KEY}"
    --mixed-model-min-cells "${MIXED_MODEL_MIN_CELLS}"
    --mixed-model-min-donors "${MIXED_MODEL_MIN_DONORS}"
    --mixed-model-min-studies "${MIXED_MODEL_MIN_STUDIES}"
